...
from new_raspilot.raspilot_implementation.providers.orientation_provider import ROrientationProvider
...
if __name__ == "__main__":
    ...
    try:
        ...
        builder.with_orientation_provider(ROrientationProvider())
