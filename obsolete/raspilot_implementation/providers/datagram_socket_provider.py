...
class DatagramSocketProvider(obsolete.raspilot.providers.base_provider.BaseProvider):
    @staticmethod
    ...
    def __init__(self, port, recv_size, name=None):
        obsolete.raspilot.providers.base_provider.BaseProvider.__init__(self, None, name)
