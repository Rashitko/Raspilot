...
from obsolete.raspilot_implementation.commands.panic_command import PanicCommand
...
class RaspilotAlarmist(Alarmist):
    ...
    def _panic(self, utilization):
        ...
        self.raspilot.send_command(PanicCommand(True, self.__panic_delay, utilization))
