...
from raspilot.commands.orientation_command import OrientationCommand
...
class RaspilotOrientationProvider(BaseOrientationProvider):
    ...
    def _execute_initialization(self):
        ...
        self.__command_handle = self.up.command_executor.register_command(OrientationCommand.NAME,
